...
#! __:timer/10s/create_curse_ward2
{
    ...
    execute positioned as @s as @e[type=item,scores={__time_alive=2..,__arg1=1..},distance=..1,nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379300}}},sort=nearest,limit=4] run kill @s
    ...
    execute as @e[type=item,scores={__time_alive=2..,__result1=4..},nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379300}}},limit=1] run function __:timer/10s/retry_curse_ward2
    {
        # recount close & on fire curse wards 1s into their __result1 score
        execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379300}}}] run function __:timer/10s/check_curse_ward1
...
#! __:timer/10s/create_curse_ward3
{
    ...
    execute positioned as @s as @e[type=item,scores={__time_alive=2..,__arg1=1..},distance=..1,nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379301}}},sort=nearest,limit=4] run kill @s
    ...
    execute as @e[type=item,scores={__time_alive=2..,__result1=4..},nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379301}}},limit=1] run function __:timer/10s/retry_curse_ward3
    {
        # recount close & on fire curse wards 2s into their __result1 score
        execute as @e[type=minecraft:item,nbt={Item:{id:"minecraft:enchanted_book",tag:{CustomModelData:379301}}}] run function __:timer/10s/check_curse_ward2
