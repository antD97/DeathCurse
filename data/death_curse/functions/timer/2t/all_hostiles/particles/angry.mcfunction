...
execute as @s[type=drowned] run function __:timer/2t/all_hostiles/particles/zombie
...
execute as @s[type=hoglin] run function __:timer/2t/all_hostiles/particles/hoglin
#!find=magma_cube
#!replace=magma_cube|slime
execute as @s[type=magma_cube] run function __:timer/2t/all_hostiles/particles/slime
...
execute as @s[type=zoglin] run function __:timer/2t/all_hostiles/particles/zoglin
...
#! __:timer/2t/all_hostiles/particles/hoglin
{
...
#! __:timer/2t/all_hostiles/particles/slime
{
...
#! __:timer/2t/all_hostiles/particles/zoglin
{
    # check if baby (0=not baby, 1=baby)
...
#! __:timer/2t/all_hostiles/particles/zombie
{
    # check if baby (0=not baby, 1=baby)
    execute store result score global __result1 run data get entity @s IsBaby
