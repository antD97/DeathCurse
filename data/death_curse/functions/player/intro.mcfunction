...
# ensure an id value exists # update id
scoreboard players add @s death_curse_id 0
execute if score @s death_curse_id matches 0 run function death_curse:player/assign_id
...
# mark as introduced
scoreboard players set @s death_curse_introduced 1
