...
#! {
    #!sb @s __n_books += 1
    execute as @s[scores={__n_books=1..256}] run function __:item/book
...
#! __:player/curse_level
{
    ...
    execute if score @s __curse_level matches 0 run tellraw @s {"text":"Current curse level: 0"}
    execute if score @s __curse_level matches 1 run tellraw @s ["",{"text":"Current curse level: "},{"text":"1","color":"#AA0000"}]
    execute if score @s __curse_level matches 2 run tellraw @s ["",{"text":"Current curse level: "},{"text":"2","color":"#990000"}]
    execute if score @s __curse_level matches 3 run tellraw @s ["",{"text":"Current curse level: "},{"text":"3","color":"#880000"}]
    execute if score @s __curse_level matches 4 run tellraw @s ["",{"text":"Current curse level: "},{"text":"4","color":"#770000"}]
    execute if score @s __curse_level matches 5 run tellraw @s ["",{"text":"Current curse level: "},{"text":"5","color":"#660000"}]
    execute if score @s __curse_level matches 6 run tellraw @s ["",{"text":"Current curse level: "},{"text":"6","color":"#550000"}]
    execute if score @s __curse_level matches 7 run tellraw @s ["",{"text":"Current curse level: "},{"text":"7","color":"#440000"}]
    execute if score @s __curse_level matches 8 run tellraw @s ["",{"text":"Current curse level: "},{"text":"8","color":"#330000"}]
    execute if score @s __curse_level matches 9 run tellraw @s ["",{"text":"Current curse level: "},{"text":"9","color":"#220000"}]
    execute if score @s __curse_level matches 10.. run tellraw @s ["",{"text":"Current curse level: "},{"score":{"name":"@s","objective":"__curse_level"},"color":"#000000"}]
}
...
#! __:player/heartbeat
{
    ...
    execute if score global __result1 matches 0..4 positioned as @s run playsound minecraft:death_curse.slow_heartbeat ambient @s ~ ~10000 ~ 100000000 1 1
    execute if score global __result1 matches 5..9 positioned as @s run playsound minecraft:death_curse.fast_heartbeat ambient @s ~ ~10000 ~ 100000000 1 1

    # initial sound
    #!sb @s __feared_init += 0
    execute if score global __result1 matches 9 run execute as @s[scores={__feared_init=0}] positioned as @s run playsound minecraft:ambient.underwater.loop.additions.ultra_rare ambient @s ~ ~10000 ~ 100000000 1 1
