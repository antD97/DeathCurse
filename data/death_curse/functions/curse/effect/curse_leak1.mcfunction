...
execute if score global __result1 matches 0 as @e[type=minecraft:blaze] run function __:curse/effect/curse_leak1/mark_hostile
...
# Mark cloak1-able mobs with __hostile score
...
#! __:curse/effect/curse_leak1/mark_hostile
{
    ...
    execute if score @s __cloak1_id = global __arg1 run scoreboard players add global __result1 1
