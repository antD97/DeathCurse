...
scoreboard players set @s death_curse_fatigue1 1
# set particle effect end time
scoreboard players operation @s death_curse_fatigue1_end = global death_curse_effect_timer
scoreboard players add @s death_curse_fatigue1_end 5
