...
execute if score global death_curse_result matches 0 run function death_curse:curse/effect_group/level7_1m40s
...
execute if score global death_curse_result matches 0 run function death_curse:curse/effect/poison2

# 5m ((effect timer + offset4) % 300): curse leak
scoreboard players operation global death_curse_result = global death_curse_effect_timer
...
execute if score global death_curse_result matches 0 positioned as @s run function death_curse:curse/effect/curse_leak2
